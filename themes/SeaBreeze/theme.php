<?php
// File: $Id: theme.php 16598 2005-08-04 21:25:13Z markwest $ $Name$
...
global $engine, $thename, $themepath, $imagepath, $xanthia_theme, $colors;
...
// set the theme path
$themepath = pnGetBaseURI().'/themes/'.$thename;
...
// Generic non-graphical container
function OpenTable3() {
	global $colors;
        echo "<!-- Begin OpenTable3-->
<div class=\"opentable\" style=\"background-color: $colors[background]; border: 1px solid $colors[sepcolor]; 
text-align: left; padding: 8px; margin-bottom: 15px;\">\n"; // color1
}
...
// Legacy Function: Formats the Left and Right sideblocks
