<?php
// $Id: function.themestylesheet.php 14250 2004-08-10 12:35:48Z markwest $
// ----------------------------------------------------------------------
 ...
 * @subpackage   Xanthia
 * @version      $Id: function.themestylesheet.php 14250 2004-08-10 12:35:48Z markwest $
...
$csssrc = '';      
if (file_exists(''.pnConfigGetVar('temp').'/Xanthia_Config/'.$themename.'.style.css')) {
$csssrc =	"".pnConfigGetVar('temp')."/Xanthia_Config/$themename.style.css";
}
