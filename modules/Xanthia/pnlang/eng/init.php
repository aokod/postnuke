<?php
// $Id: init.php 13608 2004-05-24 09:32:23Z markwest $
...
// Init Defines
define('_XA_CREATETABLEFAIL','Sorry! Failed to create table ');
define('_XA_FILLTABLEFAIL','Sorry! Failed to fill table');
?>