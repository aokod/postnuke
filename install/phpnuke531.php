<?php 
// File: $Id: phpnuke531.php 15630 2005-02-04 06:35:42Z jorg $
// ----------------------------------------------------------------------
...
mysql_query("ALTER TABLE $user_prefix" . _users . " DROP newsletter");
// Author's Table Alteration (Add Newsletter field)
mysql_query("ALTER TABLE $prefix" . _authors . " DROP radminnewsletter");
